<template>
  <div class="header">
    <a href="#/">
      <img src="./../../assets/logo1.jpg" alt="" class="logo" width="25px" />
      <span class="header-name">LearnGuard </span>
    </a>
...
import { formateTime, formateDate } from "./../../utils/dateUtils";
import { onMounted, reactive, ref, nextTick } from "vue";
import useUserStore from "./../../store/modules/user"; //"@/store/models/user"
